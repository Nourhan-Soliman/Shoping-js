...
const updatedProducts = [
      ...
      { id: 29, title: "Suit", size: "large", imageUrl: "../images/suit1.jpg", qty: 1 },
      { id: 30, title: "Suit", size: "medium", imageUrl:"../images/suit2.jpg", qty: 1 },
      { id: 31, title: "Suit", size: "small", imageUrl: "../images/suit3.jpg", qty: 1 },
      { id: 32, title: "Suit", size: "large", imageUrl: "../images/suit4.jpg", qty: 1 },
      { id: 33, title: "Suit", size: "medium", imageUrl: "../images/suit5.jpg", qty: 1 },
      { id: 34, title: "Suit", size: "small", imageUrl: "../images/suit6.jpg", qty: 1 },
      { id: 35, title: "Suit", size: "large", imageUrl: "../images/suit7.jpg", qty: 1 },
      { id: 36, title: "Suit", size: "medium", imageUrl: "../images/suit8.jpg", qty: 1 },
  ...
  function drawProductUI(products = []) {
    console.log('Drawing UI with products:', products); 
